...
public class QrController {
	...
	public String genrateQRCode(@ModelAttribute("qr") QrPojo qrPojo, Model model) {
		...
		try {
			...
			File output = new File("E:\\workspace-spring-tool-suite-4-4.18.0.RELEASE\\QR_Code\\src\\main\\resources\\static"+qrPojo.getFirstName()+".jpg");
